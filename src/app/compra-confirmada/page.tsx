  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-6 py-10 text-slate-100">
      <section className="w-full max-w-2xl rounded-2xl border border-emerald-500/30 bg-slate-900 p-8">
        ...
        <h1 className="mt-2 text-2xl font-bold">Próximo passo para acessar o Planify</h1>
        <p className="mt-3 text-sm text-slate-300">
          Se você comprou por uma página de vendas, seu acesso é liberado automaticamente pelo webhook da
          Kiwify.
        </p>
        ...
        <p className="mt-4 text-xs text-slate-400">
          Importante: use o mesmo email da compra para a liberação automática funcionar.
        </p>
      </section>
    </main>
  );
